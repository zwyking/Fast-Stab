...
class RandomHomography:
    ...
    def __init__(self, p_flip=0.0, max_rotation=0.0, max_shear=0.0, max_scale=0.0, min_scale=0.0, max_ar_factor=0.0,
    ...
    def roll(self):
        ...
        scale_factor = np.exp(random.uniform(self.min_scale, self.max_scale))
